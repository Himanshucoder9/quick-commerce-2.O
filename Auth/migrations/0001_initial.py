    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(help_text='Alphabets and special characters are not allowed (eg.+911234567890).', max_length=13, unique=True, validators=[Master.myvalidator.mobile_validator], verbose_name='mobile number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(decimal_places=9, max_digits=12, verbose_name='latitude')),
                ('longitude', models.DecimalField(decimal_places=9, max_digits=12, verbose_name='longitude')),
                ('full_address', models.TextField(verbose_name='full address')),
                ('warehouse_no', models.CharField(max_length=15, unique=True, verbose_name='warehouse number')),
                ('warehouse_name', models.CharField(max_length=100, verbose_name='registered warehouse name')),
                ('license', models.FileField(help_text='Upload license proof.', upload_to='auth/warehouse/license', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'png', 'jpg', 'jpeg', 'webp'])], verbose_name='license proof')),
                ...
                ('identity_document', models.FileField(help_text='Upload Identity Document.', upload_to='auth/warehouse/identity', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['pdf', 'png', 'jpg', 'jpeg', 'webp'])], verbose_name='identity document')),
                ...
                ('warehouse_image', imagekit.models.fields.ProcessedImageField(help_text='Upload warehouse image.', upload_to='auth/warehouse/', verbose_name='shop image')),
                ('warehouse_image_owner', imagekit.models.fields.ProcessedImageField(help_text='Upload warehouse image with owner.', upload_to='auth/warehouse/owner/', verbose_name='shop image with owner')),
                ('approved', models.BooleanField(default=False, verbose_name='Approved')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='General.city', verbose_name='city')),
                ('state', models.ForeignKey(max_length=250, on_delete=django.db.models.deletion.CASCADE, to='General.state', verbose_name='state')),
            ],
            options={
