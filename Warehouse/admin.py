...
class CategoryAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ('warehouse', 'title', '_image', 'is_deleted', 'created_at')
    list_filter = ('title', 'warehouse', 'is_deleted', 'created_at', 'updated_at')
    search_fields = ('title',)
    readonly_fields = ('created_at', 'updated_at')
    list_per_page = 15
    ...
    fieldsets = (
        (_('Category Info'), {
            'fields': ('warehouse', 'title', 'image', 'is_deleted'),
        }),
        (_('Timestamp'), {
            'fields': ('created_at', 'updated_at'),
        }),
...
class SubCategoryAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ('warehouse', 'title', 'category', '_image', 'is_deleted', 'created_at')
    list_filter = ('title', 'category', 'warehouse', 'is_deleted')
    ...
    fieldsets = (
        (_('Sub Category Info'), {
            'fields': ('warehouse', 'category', 'title', 'image', 'is_deleted'),
        }),
        (_('Timestamp'), {
            'fields': ('created_at', 'updated_at'),
        }),
